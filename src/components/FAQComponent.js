    ...
    <section style={sectionStyle}>
      ...
      <div className="lg:flex lg:justify-evenly mb-2">
        ...
        <div className="flex lg:justify-evenly my-8">
          <a className="px-2 mx-auto lg:m-0" href="#"><img src="assets/images/linkedin.png" alt="linkedin" /></a>
          <a className="px-2 mx-auto lg:m-0" href="#"><img src="assets/images/twitter.png" alt="twitter" /></a>
          <a className="px-2 mx-auto lg:m-0" href="#"><img src="assets/images/facebook.png" alt="fb" /></a>
          <a className="px-2 mx-auto lg:m-0" href="#"><img src="assets/images/instagram.png" alt="ig" /></a>
        </div>
      </div>
    </section>
  );
