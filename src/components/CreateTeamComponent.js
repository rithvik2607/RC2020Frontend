...
const CTeam = () => {
  return(
    <div>
      <div className="rounded-2xl dashboardBlue py-20 lg:py-24 lg:px-36">
        <p className="DM700 text-2xl lg:text-5xl text-center text-white mb-4 -mt-16">Create Team</p>
        ...
        <div className="rounded-2xl bg-black mx-20 py-6 px-4 lg:px-20">
          ...
          <input className="rounded-lg bg-black block ring-2 h-4 w-40 lg:h-8 lg:w-64 ring-dashboardBlue focus:outline-none text-white"></input><br />
