    ...
    <section style={sectionStyle}>
      <div className="pb-24">
          <div className="md:flex md:justify-center lg:justify-between mx-16 lg:mx-32 mt-2">
            ...
            <a href="https://reverse-coding-2020.herokuapp.com/auth/google"><div className="hidden lg:block transition duration-300 ease-in-out transform hover:scale-110 cursor-pointer rounded-lg px-8 py-2 rcBlueBg text-white DM400 mt-4 text-justify">Register or Sign In</div></a>
          </div>
          <div className="mx-6 md:mx-16 lg:mx-32">
            ...
            <div data-aos="fade-up" data-aos-offset="300" data-aos-delay="150" data-aos-duration="300" className="lg:pt-32">
              ...
              <a href="https://reverse-coding-2020.herokuapp.com/auth/google"><div className="float-left transition duration-300 ease-in-out transform hover:scale-110 cursor-pointer rounded-lg px-16 py-4 rcBlueBg text-white text-2xl DM400 mt-4 text-justify">Register or Sign In</div></a>
            </div>
          </div>
      </div>
    </section>
