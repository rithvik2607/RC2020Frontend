    ...
    return(
      <section style={sectionStyle} className="container mx-auto">
        <div className="flex justify-between mx-6 lg:mx-32 mt-2">
          ...
          <a href="https://acm-reverse-coding.web.app"><div className="hidden lg:block transition duration-300 ease=in-out transform hover:scale-110 cursor-pointer rounded-lg px-8 py-2 dashboardBlue text-white DM400 mt-4 text-justify">Logout</div></a>
        </div>
        <div className="flex justify-between mx-6 lg:mx-32 mt-8">
          <div data-aos="fade-up" data-aos-duration="300" data-aos-delay="100">
            ...
            <p className="text-gray-500 DM700 text-2xl lg:text-5xl">{this.state.teamName}</p>
          </div>
          ...
          <div data-aos="fade-up" data-aos-duration="300" data-aos-delay="300">
            ...
            <p className="text-white DM700 text-2xl lg:text-5xl">{this.state.score}</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-1">
            <div>
              <div className="lg:mb-6">
                <p className="DM700 text-lg lg:text-3xl text-white mb-2">Members</p>
                <p className="DM400 text-base lg:text-xl text-gray-500">{this.state.name}</p>
                <p className="DM400 text-base lg:text-xl text-gray-500">{this.state.teamMate}</p>
              </div>
              <div>
                <p className="DM700 text-lg lg:text-3xl text-white mb-4">Team Code</p>
                <textarea style={{ resize : "none" }} ref={(textarea) => this.textarea = textarea} className="DM400 bg-transparent h-8 focus: outline-none text-base lg:text-xl text-white" value={this.state.teamID} />
        ...
        <a className="flex justify-center" href="https://acm-reverse-coding.web.app/"><div className="lg:hidden transition duration-300 ease=in-out transform hover:scale-110 w-28 cursor-pointer rounded-lg px-8 py-2 dashboardBlue text-white DM400 mt-4 text-justify">Logout</div></a>
      </section>
    );
  }
}
